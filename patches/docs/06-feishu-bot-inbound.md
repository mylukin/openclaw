...
| `extensions/feishu/src/channel.ts` | 飞书 channel 实现 |
| `extensions/feishu/src/channel.test.ts` | 飞书 channel 测试 |
| `extensions/feishu/src/exports.test.ts` | 飞书扩展导出守卫测试 |
| `extensions/feishu/index.ts` | 飞书扩展入口 |
